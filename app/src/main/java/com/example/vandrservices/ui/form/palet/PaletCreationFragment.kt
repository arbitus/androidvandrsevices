...
class PaletCreationFragment : Fragment() {
    ...
    private val fieldsByFruit = mapOf(
        ...
        "Banana Organic" to generalPalet,
        "Onions" to generalPalet,
        "Aloe Vera" to generalPalet,
        "Chirimoya" to generalPalet,
        "Coco" to generalPalet,
        "Jicama" to generalPalet,
        "Purple" to generalPalet,
        "Strawberrie" to generalPalet,
    )
